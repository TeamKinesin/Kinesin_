...
namespace StellaRabbitStudio
{
    ...
    public class TMPVFX : MonoBehaviour
    {
        ...
        public bool ClearAllKeywords(Material material = null)
        {
            ...
            // VFX keywords
            targetMaterial.SetFloat("_PAPER_NOISEEnabled", 0);
            targetMaterial.SetFloat("_HANDDRAWNEnabled", 0);
            targetMaterial.SetFloat("_BLACKHOLEEnabled", 0);
            targetMaterial.SetFloat("_SKETCHOUTLINEEnabled", 0);
            targetMaterial.SetFloat("_TEXTBOXEnabled", 0);
            targetMaterial.SetFloat("_SCRIBBLENOISEEnabled", 0);
#endif
            return true;
        }
